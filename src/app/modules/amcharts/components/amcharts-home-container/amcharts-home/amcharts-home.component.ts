...
import { ChartData, ChartType, ChartLibrary } from 'src/app/services/home.service'

@Component({
  selector: 'app-amcharts-home',
  templateUrl: './amcharts-home.component.html',
  styleUrls: ['./amcharts-home.component.scss']
})
export class AmchartsHomeComponent implements OnInit {
