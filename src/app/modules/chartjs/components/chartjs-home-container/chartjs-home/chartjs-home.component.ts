...
@Component({
  selector: 'app-chartjs-home',
  templateUrl: './chartjs-home.component.html',
  styleUrls: ['./chartjs-home.component.scss']
})
export class ChartjsHomeComponent implements OnInit {
