...
@Component({
  selector: 'app-highcharts-home',
  templateUrl: './highcharts-home.component.html',
  styleUrls: ['./highcharts-home.component.scss']
})
export class HighchartsHomeComponent implements OnInit {
